...
public class Main
{
                ...
                case 4:
                    while (true)
                    {
                        ...
                        else if (showOpt == 3)
                        {
                            ...
                            while (true)
                            {
                                System.out.println("[ 60 ] Federation Of Malaysia [ 62 ] Republic of Indonesia [ 63 ] Republic of the Philippines\n" +
                                        "[ 65 ] Republic of Singapore [ 66 ] Kingdom of Thailand [ 84 ] Socialist Republic of Vietnam\n" +
                                        "[ 673 ] Brunei Darrussalam [ 855 ] Kingdom of Cambodia [ 856 ] Lao's People's Democratic Republic\n" +
                                        "[ 95 ] Republic of the Union of Myanmar [ 670 ] Democratic Republic of Timor Leste [ 0 ] Done");
    ...
    private int convertChoices(int choice)
    {
        switch (choice) {
            ...
            default:
                System.out.println("Invalid choice! Returning default country code (1).");
        
        return 0;   // Default country code
        }
    }
